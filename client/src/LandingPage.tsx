...
/**
 * Base44-style airy mesh: login darkest (#270115) only as **light** edge tints (low opacity, large soft
 * ellipses) at top + bottom, bleeding into a bright white center — same “light blur” feel as sky-blue ref.
 */
const landingBackgroundStyle: CSSProperties = {
  ...
  backgroundImage: [
    ...
    // Bright center wash (same cream as student groups page)
  ...
  return (
    ...
    >
      <main style={landingBackgroundStyle}>
        ...
        {/* Bottom waves — same shapes as login/signup; big dark wave behind, lighter wave overlapping in front */}
        <svg
          style={{
            position: "absolute",
            bottom: 0,
